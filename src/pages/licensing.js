...
function LicensingPage() {
  return (
    ...
    { text: " or through the form on the ", linkUrl: "/contact", linkText: "contact" }, {text: " page."} ]} />
      ...
      <LicenseCard heading="Template and Design" messageParts={[ { text: "The template and design implemented here is inspired by ", linkUrl: "https://alex-grant-template.webflow.io", linkText: "Alex Grant" }, { text: " webflow template, from the ", linkUrl: "https://www.lightninglab.design", linkText: " Lightning Lab design studio." },
    { text: " It was built with no-code tool ", linkUrl: "https://webflow.com", linkText: "webflow" }, {text: ", while I wrote JavaScript code for this and style with vanilla CSS using the React framework and powered it with NextJS."} ]} />
